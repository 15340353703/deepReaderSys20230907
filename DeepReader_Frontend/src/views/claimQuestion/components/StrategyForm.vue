  ...
  <div id="nav" style="height: 650px;">
    <el-scrollbar style="height:100%">
      ...
      <el-card v-if="active == 0" class="box-card">
        <div class="text item">
          创建测试题，考考你的同伴，主要目的在于检验学习者对文章主要内容、主题思想的理解，问题的答案在文章可以找到。
        </div>
      </el-card>
...
<!--              </div>-->
      ...
      <div style="text-align: center">
        ...
        <el-button v-if="active != 0 && active != 3" size="medium" type="primary" @click="next">返回</el-button>
  ...
  methods: {
    ...
    robotHelp() {
      if (this.questionForm.questionDescribe !=='' && this.questionForm.questionDescribe !==null && this.questionForm.questionClues!=='' && this.questionForm.questionClues!==null){
        ...
        // console.log('clues:' + this.questionForm.clues)
    ...
    morerobotQuestion(){
      ...
      if (isChinese){
        ...
        this.questionForm.questiocluesnClues = 'Please ask multiple questions and provide answers in the form of a question and answer based on the following paragraph:'+this.questionForm.questionClues
      }
      console.log('clues:'+ this.questionForm.clues)
      // this.sendChatGPT(this.questionForm).then((res) =>{
      //   console.log(res)
