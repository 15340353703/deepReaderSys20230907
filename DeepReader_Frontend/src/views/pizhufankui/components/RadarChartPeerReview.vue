        ...
        series: [
          {
            ...
            data: [
              {
                value: [this.chartData.dayi, this.chartData.zhiyi, this.chartData.chanshi, this.chartData.xieshang, this.chartData.shejiao],
                name: '同伴评论类型',
                symbolSize: 2,
                symbolColor: '#3399FF',
                // symbolColor: '#47EDFC',
