  ...
  <div id="d1">
    <el-row>
      ...
      <el-col :span="14">
        ...
        <div v-permission="['teacher']" style="text-align: center">
        ...
        <div>
          <el-dialog :visible.sync="dialogFormVisible">
            ...
            <el-form ref="discussionForm" style="height: 300px; overflow: auto" :model="discussionForm" label-width="80px">
              <el-form-item label="讨论主题">
                <el-input v-model="discussionForm.topic" />
              </el-form-item>
              <el-form-item label="讨论内容">
                <el-input v-model="discussionForm.content" type="textarea" />
              </el-form-item>
...
export default {
  ...
  methods: {
    ...
    ...mapActions('discussion', ['getDiscussionList', 'submitDiscussion','getUserDiscussionList']),
    getClassifyList() {
    ...
    getShowForm(page, pageSize) {
      this.getUserDiscussionList(page, pageSize).then(response => {
