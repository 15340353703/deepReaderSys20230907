<template>
  <el-card style="margin-bottom:20px;">
    ...
    <div class="user-profile">
      ...
      <div class="box-center">
        <div class="user-name text-center">{{ user.yourname }}</div>
    ...
    <div class="user-bio">
      ...
      <div class="user-education user-bio-section">
        <div class="user-bio-section-header"><svg-icon icon-class="peoples" /><span>hypothesis</span></div>
        <div class="user-bio-section-body">
          <div> {{ userInfo.hypothesisname }} </div>
        </div>
      </div>
    </div>
  </el-card>
