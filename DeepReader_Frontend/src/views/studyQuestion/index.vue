            ...
            <el-col :span="questionSpan" :xs="24">
              <el-card>
                <el-tabs v-model="activeTab">
                  <el-tab-pane label="你的问题列表" name="strategyForm">
                    <strategyForm
                      :user="user"
                      :book="book"
                      @close="closeContent()"
              ...
              <el-col :span="contentSpan" :xs="24">
                <el-card>
                  <el-tabs v-model="activeTab2" @tab-click="handleclick">
                    <el-tab-pane label="问题反馈报告" name="chapter">
                      <chapter :book="book" />
                    </el-tab-pane>
  ...
  methods: {
    ...
    handleclick(obj){
      if(obj.name==='myContent') {
        const data = {userid: getToken(),behavior:'查看文章',bookid:this.bookid,stamptime:new Date()}
